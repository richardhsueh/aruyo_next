...
const orderBy = require("lodash/orderBy.js");
...
function getRecipeBySlug(slug, fields = []) {
...
exports.getAllRecipes = function (fields = []) {
  const slugs = getRecipeSlugs();
  return orderBy(
    slugs.map((slug) => getRecipeBySlug(slug, fields)),
    ["date", "slug"],
    ["desc", "asc"]
  );
};
